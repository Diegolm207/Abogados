...
<body class="bgsilver">
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <!-- Brand -->
        <a class="navbar-brand" href="home.php">Plataforma de Gestión Jurídica - Documento - 
            <?php 
    ...
    <form name=dataidu class="w3-container" action="../controller/cntDoc.php" method="post">
                ...
                <table class="table table-striped" style="font-size: 75%">                    
                    <?php
                        ...
                        if (isset($_REQUEST['docid'])){ 
                            selectDocById($_REQUEST['docid'], $obj, $objid);
                        }
                        else {
                            selectDocById(-1, $obj, $objid);
                        }
                    ?>
                </table>
            </div>
