<?php     
    include '../controller/cntEntity.php';
...
<body class="bgsilver">
    ...
    <table class="table table-borderless">
        <tr>
            <td>
                <h4><a href="entities.php" style="align: right; color: black">CLIENTES</a></h4>
            </td>
            <td>
                <form class="w3-container" action="../controller/cntEntity.php" method="post">
                    Buscar: <input type="text" name="entfilter" id="txtfilter" size="40" value="">
            ...
            <td style="text-align: right">
                ...
                <a href="entitydata.php?insert" target="_blank" class="btn btn-dark btn-md" role="button">Nuevo</a>                                                       
            </td>
        </tr>
    </table>
            ...
            <form class="w3-container" action="../controller/cntEntity.php" method="post">
                <table class="table table-striped" style="font-size: 75%">
                    <tr><th>Total Registros:</th>
                        <th>
                            <?php 
                            if (isset ($_SESSION['numentities'])){
                                echo $_SESSION['numentities']; 
                            }
                            ?>
                        </th></tr>
                    <?php 
                    if (isset($_REQUEST['identity'])){ 
                        showEntity($_REQUEST['identity']);
                    }
                    else {
                        showEntity(-1);
                    }
