...
<body class="bgsilver">
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <!-- Brand -->
        <a class="navbar-brand" href="home.php">Plataforma de Gestión Jurídica - Cliente - 
            <?php 
    ...
    <form name=dataidu class="w3-container" action="../controller/cntEntity.php" method="post">
        ...
        <div class="row">
            <div class="col-md-6">
                <table class="table table-striped" style="font-size: 75%">
                    <?php
                        echo '<tr><td>Acción:</td><td><input type="text" name="entidu" value="'. $mode.'" readonly></td><td></td></tr>';
                        /*Show form with data or empty*/
                        if (isset($_REQUEST['identity'])){ 
                            selectEntityById($_REQUEST['identity']);
                        }
                        else {
                            selectEntityById(-1);
                        }
