...
<html>
    ...
    -->
<head>
    <title>ERP - Alberto Martínez - Facturación</title>  
    <meta charset="utf-8">
...
<body class="bgsilver">
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <!-- Brand -->
        <a class="navbar-brand" href="home.php">Plataforma de Gestión Jurídica - Facturación - 
            <?php 
    ...
    <form name=dataidu class="w3-container" action="../controller/cntInvoice.php" method="post">
        ...
        <div class="row">
            <div class="col-md-6">
                <table class="table table-striped" style="font-size: 75%">
                    <?php
                        echo '<tr><td>Acción:</td><td><input type="text" name="invidu" value="'. $mode.'" readonly></td><td></td></tr>';
                        /*Show form with data or empty*/
                        if (isset($_REQUEST['idinvoice'])){ 
                            selectInvoiceById($_REQUEST['idinvoice']);                            
                        }
                        else {
                            selectInvoiceById(-1);
                        }
