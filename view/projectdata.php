...
<html>
    ...
    -->
<head>
    <title>ERP - Alberto Martínez - Asunto</title>  
    <meta charset="utf-8">
...
<body class="bgsilver">
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <!-- Brand -->
        <a class="navbar-brand" href="home.php">Plataforma de Gestión Jurídica - Asunto - 
            <?php 
                if (isset ($_REQUEST['prjinsert'])){                
                    $_SESSION['mode'] = 'prjinsert';
                    $mode='NUEVO';
                    echo 'Nuevo';
                }
    ...
    <form name=dataidu class="w3-container" action="../controller/cntProject.php" method="post">
        ...
        <div class="row">
            <div class="col-md-6">
                <table class="table table-striped" style="font-size: 75%">
                    <?php
                        echo '<tr><td>Acción:</td><td><input type="text" name="prjidu" value="'. $mode.'" readonly></td><td></td></tr>';
                        /*Show form with data or empty*/
                        if (isset($_REQUEST['idproject'])){ 
                            selectedProjectById($_REQUEST['idproject']);
                        }
                        else {
                            selectedProjectById(-1);
                        }
                    ?>
                </table>
            </div>
