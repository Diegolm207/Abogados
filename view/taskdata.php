...
<html>
    ...
    -->
<head>
    <title>ERP - Alberto Martínez - Tarea</title>  
    <meta charset="utf-8">
...
<body class="bgsilver">
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <!-- Brand -->
        <a class="navbar-brand" href="home.php">Plataforma de Gestión Jurídica - Tarea - 
            <?php 
    ...
    <form name=dataidu class="w3-container" action="../controller/cntTask.php" method="post">
        ...
        <div class="row">
            <div class="col-md-6">
                <table class="table table-striped" style="font-size: 75%">
                    <?php
                        echo '<tr><td>Acción:</td><td><input type="text" name="tskidu" value="'. $mode.'" readonly></td><td></td></tr>';
                        /*Show form with data or empty*/
                        if (isset($_REQUEST['idtask'])){ 
                            selectedTaskById($_REQUEST['idtask']);
                        }
                        else {
                            selectedTaskById(-1);
                        }
